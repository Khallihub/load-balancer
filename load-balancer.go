...
func main() {
	servers := []Server{
		newSimpleServer("https://distributed-doc.onrender.com"),
		newSimpleServer("https://distributed-doc-2.onrender.com"),
		newSimpleServer("https://distributed-doc-3.onrender.com"),
	}
